#===============================================================================
title =    ROOT.TLatex( 0.55, 1.20,"J^{P}=0^{#minus}")
states = [ ROOT.TLatex(-0.90, 0.05, "#pi^{#minus}"),
           ROOT.TLatex( 0.10, 0.10, "#pi^{0}"     ),
           ROOT.TLatex( 0.85, 0.05, "#pi^{+}"     ),
           ROOT.TLatex(-0.70, 0.80, "K^{0}"       ),
           ROOT.TLatex( 0.60, 0.80, "K^{+}"       ),
           ROOT.TLatex(-0.70,-0.90, "K^{#minus}"  ),
           ROOT.TLatex( 0.60,-0.90, "#bar{K}^{0}" ),
           ROOT.TLatex(-0.20,-0.20, "#eta"        ),
           ROOT.TLatex( 0.10,-0.20, "#eta\'"      ) ]
#===============================================================================
# BEGIN
#===============================================================================
